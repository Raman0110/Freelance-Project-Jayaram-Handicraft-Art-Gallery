                    ...
                    >
                      <SwiperSlide>
                        <div className="product-thumbnail-image">
                          <img src={`http://localhost:8000/uploads/products/thumbnails/${product.image}`} className='cursor-pointer product-thumbnail' />
                        </div>
                      </SwiperSlide>
                      {product.thumbnails.map((thumbnail, index) => (
                        <SwiperSlide key={index}>
                          <div className="product-thumbnail-image">
                            <img src={`http://localhost:8000/uploads/products/thumbnails/${thumbnail}`} className='cursor-pointer product-thumbnail' />
                          </div>
                        </SwiperSlide>
                      ))}
                    </Swiper>
                    ...
                    >
                      <SwiperSlide>
                        <div className="img-container max-w-[450px] h-[450px] mx-auto">
                          <img src={`http://localhost:8000/uploads/products/${product.image}`} className='w-full h-full object-contain' />
                        </div>
                      </SwiperSlide>
                      {product.thumbnails.map((thumbnail, index) => (
                        <SwiperSlide key={index}>
                          <div className="img-container max-w-[450px] h-[450px] mx-auto">
                            <img src={`http://localhost:8000/uploads/products/${thumbnail}`} className='w-full h-full object-contain' />
                          </div>
                        </SwiperSlide>
                      ))}
                    </Swiper>
