          ...
          <div className="form-sec px-4 w-1/2 max-md:w-full">
            ...
            <form action="" className='mb-4'>
              <div className="relative form-input w-full mb-2">
                <input type="text" name="" id="" className='w-full border-gray-400 border rounded-md outline-[#0D276A] p-2 ps-8' placeholder='Name' />
                <FontAwesomeIcon icon={faUser} className='absolute left-2 top-3 text-gray-400' />
              </div>
              <div className="relative form-input mb-2">
                <input type="email" name="" id="" className='w-full border-gray-400 border rounded-md outline-[#0D276A] p-2 ps-8' placeholder='Email' />
                <FontAwesomeIcon icon={faEnvelope} className='absolute left-2 top-3 text-gray-400' />
              </div>
              <textarea name="" id="" placeholder='Message' className='border-gray-400 border w-full outline-[#0D276A] p-2 rounded-md' rows='6' />
