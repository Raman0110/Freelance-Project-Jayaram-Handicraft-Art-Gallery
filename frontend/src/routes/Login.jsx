...
const Login = () => {
  ...
  const handleLogIn = async (e) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_host}/api/auth/login`, { email, password }, { withCredentials: true });
      navigate("/dashboard");
    } catch (error) {
      e.target.reset();
      ...
      <div className="flex relative">
        ...
        <div className="left-section w-3/4 max-lg:w-full">
          <div className="loginImgDiv h-[100vh]">
            <img src="/images/sliderImg1.jpg" alt="" className='w-full h-full object-cover' />
          </div>
          <div className="loginForm max-sm:w-11/12 absolute top-[50%] left-[50%] max-lg:-translate-x-1/2 -translate-y-1/2 lg:left-[65%] p-6 rounded-md bg-white text-[#0D276A] shadow-md">
            ...
            <h2 className='text-lg font-bold'>Welcome to Jayaram Handicraft Art Gallery</h2>
