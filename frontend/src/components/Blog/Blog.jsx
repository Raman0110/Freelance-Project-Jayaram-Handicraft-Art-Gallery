  ...
  return (
    <section className='py-4'>
      <div className="container mx-auto px-4 sm:px-0">
        <h2 className='py-8 text-center text-3xl font-bold text-[#E64D3D]'>BLOG</h2>
        <div className="blogCategory flex items-center gap-2 justify-end cursor-pointer relative">
          <p className='font-bold categoryTitle text-[#0D276A]'>All Category</p>
          <FontAwesomeIcon icon={faAngleDown} size='lg' className='text-[#E64D3D] categoryIcon' />
        ...
        <div className="blogContainer grid gap-4 xl:grid-cols-2 xl:grid-rows-2 xl:gap-4 mt-8">
          <div className="bigBlogCard flex w-full gap-2 xl:gap-4 xl:flex-col  xl:row-span-2">
            ...
            <div className="blogDesc">
              <h2 className='cursor-pointer font-bold text-lg lg:text-2xl pb-2 text-[#0D276A]'>10 Facts About Gautam Buddha</h2>
          ...
          <div className="smallBlogCard flex gap-2">
            ...
            <div className="blogDesc">
              <h2 className='font-bold text-lg lg:text-2xl cursor-pointer pb-2 text-[#0D276A]'>Must Known Facts About Green Tara Devi</h2>
